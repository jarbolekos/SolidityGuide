...
const contractABI = require("../artifacts/contracts/Solidityguide.sol/Solidityguide.json").abi;

program
    .name("solidityguide-cli")
    .description("CLI tool for Solidityguide smart contract")
    .version("1.0.0");
